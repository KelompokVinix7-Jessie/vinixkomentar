...
tasks: JSON.parse(localStorage.getItem('app_tasks')) || {
    ...
    upcoming: [
        {
            ...
            deadline: "2025-11-27",
            status: "open" // DIUBAH dari "overdue" menjadi "open"
        },
        {
            id: 2,
            type: "Weekly Task",
    ...
    logbooks: Array.from({length: 10}, (_, i) => ({
        ...
        status: i < 2 ? "completed" : i === 2 ? "open" : "open", // DIUBAH: week 2 jadi "open"
        ...
        // Weekly tasks - Hanya satu versi dengan commentThread
            ...
            commentThread: i < 1 ? [
                {
                    ...
                    message: "Excellent work! Very thorough analysis and implementation.",
                ...
                },
                {
                    ...
                    timestamp: new Date('2025-01-15T14:20:00').toISOString()
                },
                {
                    id: 3,
                    sender: "mentor",
                    senderName: "Mentor John",
                    message: "Great! Looking forward to seeing the updated version.",
                    timestamp: new Date('2025-01-16T09:15:00').toISOString()
                }
            ] : [],
